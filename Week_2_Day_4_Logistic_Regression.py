...
with open("04_logistic_regression_results.txt", "w") as file:
...
predictions.to_csv(
    "04_logistic_regression_predictions.csv",
    index=False
)
...
print("04_logistic_regression_results.txt")
print("04_logistic_regression_predictions.csv")

print("\nDay 4 Logistic Regression completed successfully.")